...
const Mixer = () => {
	...
	const [reverseConfig, setReverseConfig] = useState(false);
	const [thermomanometer, setThermomanometer] = useState(false);
	...
	const solutionMixer = () => {
		if (consumption && pressure) {
			...
			const isMatch = result =>
				(0.15 <= result.valveАuthority ||
					0.15 * 0.9 <= result.valveАuthority) &&
				(result.valveАuthority <= 0.8 || result.valveАuthority <= 0.8 * 1.1) &&
	...
	function copyNameMixer(mixerName) {
		const mixerText = `Смесительный узел ${type} ${mixerName} с ${valve}-х ходовым клапаном${
			thermomanometer ? ' и термоманометрами' : ''
		}${reverseConfig ? ' (Обратной конфигурации)' : ''}`;
				...
				<form className='form'>
					...
					<div className='form__item'>
						<label className='form__label'>
							Падение давления жидкости в ТО (кПа):
						</label>
						<input
							className='form__input'
							type='number'
					...
					<div className='form__item'>
						<input
							...
							name='type'
							value='SU'
							checked={type == 'SU' ? true : false}
							onChange={onChangeType}
						/>
						<label className='form__label label__radio' htmlFor='radio_su'>
							SU
							<span></span>
						</label>
						<input
							...
							name='type'
							value='MSU'
							checked={type == 'MSU' ? true : false}
							onChange={onChangeType}
						/>
						<label className='form__label label__radio' htmlFor='radio_msu'>
							MSU
							<span></span>
						</label>
						<input
							...
							name='valve'
							value='2'
							checked={valve == '2' ? true : false}
							onChange={onChangeValve}
						/>
						<label className='form__label label__radio' htmlFor='radio_valve_2'>
							2-х ходовой клапан
							<span></span>
						</label>
						<input
							...
							name='valve'
							value='3'
							checked={valve == '3' ? true : false}
							onChange={onChangeValve}
						/>
						<label className='form__label label__radio' htmlFor='radio_valve_3'>
							3-х ходовой клапан
							<span></span>
						</label>
					</div>
					...
					<div className='form__item'>
						<input
							...
							onChange={() => {
								setReverseConfig(!reverseConfig);
							}}
						/>
						<label className='form__label label__check' htmlFor='reverseConfig'>
						...
						<input
							...
							id='thermomanometer'
							type='checkbox'
							name='thermomanometer'
							checked={thermomanometer}
							onChange={() => {
								setThermomanometer(!thermomanometer);
							}}
						/>
						<label
							className='form__label label__check'
							htmlFor='thermomanometer'
						>
							Термоманометр
							<span></span>
						</label>
					...
					{/* <div className='form__item'>
						<label className='form__label'>
							<p className='form__label-text'>SU</p>
							<input
								className='form__radio'
								type='radio'
								name='type'
						...
						<label className='form__label'>
							<p className='form__label-text'>MSU</p>
							<input
								className='form__radio'
								type='radio'
								name='type'
						...
						<label className='form__label'>
							<p className='form__label-text'>2-х ходовой клапан</p>
							<input
								className='form__radio'
								type='radio'
								name='valve'
						...
						<label className='form__label'>
							<p className='form__label-text'>3-х ходовой клапан</p>
							<input
								className='form__radio'
								type='radio'
								name='valve'
					...
					{/* <div className='form__item'>
						<label className='form__label'>
							<p className='form__label-text'>Обратной конфигурацией</p>
							<input
								className='form__checkbox'
								type='checkbox'
								name='valve'
						...
						<label className='form__label'>
							<p className='form__label-text'>Термоманометр</p>
							<input
								className='form__checkbox'
								type='checkbox'
								name='thermomanometer'
					...
					<tbody className='table__result'>
						...
						{resultTable.map(result => (
							<tr
								className={[
									styles.row,
									result.match ? styles.row__match : '',
								].join(' ')}
							...
							>
								...
								{0.15 * 0.9 <= result.valveАuthority ? (
									...
									<td style={{ backgroundColor: 'rgb(155, 12, 9, 0.75)' }}>
										&gt;
									</td>
								)}
								<td>
									{result.valveАuthority
										.toFixed(roundingNumbers)
										.replace(/\./, ',')}
								</td>
